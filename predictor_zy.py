...
# from utils_zy import MyDefaultPredictor
from detectron2.utils.video_visualizer import VideoVisualizer
from detectron2.utils.visualizer import ColorMode, Visualizer
from detectron2.config import LazyConfig, instantiate
from detectron2.checkpoint import DetectionCheckpointer
import detectron2.data.transforms as T
class MyDefaultPredictor:
    """
    ...
    def __init__(self, cfg):
        ...
        self.aug = T.ResizeShortestEdge(
             [cfg.dataloader.test.mapper.augmentations[0].short_edge_length, 
            cfg.dataloader.test.mapper.augmentations[0].short_edge_length], 
            cfg.dataloader.test.mapper.augmentations[0].max_size
        )

        self.input_format = self.cfg.dataloader.train.mapper.image_format
...
class MyVisualizationDemo(object):
    def __init__(self, cfg, instance_mode=ColorMode.IMAGE, parallel=False):
        ...
        if parallel:
            ...
            self.predictor = MyDefaultPredictor(cfg)
