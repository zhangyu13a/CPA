...
from configs.common.mask_rcnn_fpn import model
...
model.backbone = L(SimpleFeaturePyramid)(
    ...
    norm="LN",
    square_pad=608,#1024,zy：change2
)
...
model.roi_heads.box_head.fc_dims = [608]#[1024] zy：change 3
